...
from dlmm.utils import convert_to_transaction
...
class DLMM:
    ...
    def __init__(self, public_key: Pubkey, rpc: str) -> None:
        if type(public_key) != Pubkey:
            raise TypeError(
                "public_key must be of type `solders.pubkey.Pubkey`")
    ...
    def get_active_bin(self) -> ActiveBin:
        ...
        try:
            result = self.__session.get(
                f"{API_URL}/dlmm/get-active-bin").json()
    ...
    def from_price_per_lamport(self, price: float) -> float:
        ...
        try:
            ...
            result = self.__session.post(
                f"{API_URL}/dlmm/from-price-per-lamport", data=data).json()
    ...
    def to_price_per_lamport(self, price: float) -> float:
        ...
        try:
            data = json.dumps({"price": price})
            result = self.__session.post(
                f"{API_URL}/dlmm/to-price-per-lamport", data=data).json()
            return float(result["price"])
        except requests.exceptions.HTTPError as e:
            raise HTTPError(f"Error converting price per lamports: {e}")
        except requests.exceptions.ConnectionError as e:
    ...
    def initialize_position_and_add_liquidity_by_strategy(
            self, position_pub_key: Pubkey, user: Pubkey, x_amount: int,
            y_amount: int, strategy: StrategyParameters) -> Transaction:
        '''
        ...
        if type(position_pub_key) != Pubkey:
            raise TypeError(
                "position_pub_key must be of type `solders.pubkey.Pubkey`")
        ...
        try:
            ...
            raise HTTPError(
                f"Error initializing position and adding liquidity by strategy: {e}"
            )
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")

    def add_liquidity_by_strategy(self, position_pub_key: Pubkey, user: Pubkey,
                                  x_amount: int, y_amount: int,
                                  strategy: StrategyParameters) -> Transaction:
        '''
        ...
        try:
            ...
            result = self.__session.post(
                f"{API_URL}/dlmm/add-liquidity-by-strategy", data=data).json()
            transaction = convert_to_transaction(result)
            return transaction
        except requests.exceptions.HTTPError as e:
    ...
    def get_positions_by_user_and_lb_pair(self,
        ...
        try:
            data = json.dumps({"userPublicKey": str(user)})
            result = self.__session.post(
                f"{API_URL}/dlmm/get-positions-by-user-and-lb-pair",
                data=data).json()
            return GetPositionByUser(result)
        except requests.exceptions.HTTPError as e:
            raise HTTPError(
                f"Error getting positions by user and lb pair: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")

    def remove_liqidity(self, position_pub_key: Pubkey, user: Pubkey,
                        bin_ids: List[int], bps: int,
                        should_claim_and_close: bool) -> List[Transaction]:
        '''
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/remove-liquidity",
                                         data=data).json()
            return [
                convert_to_transaction(tx_data) for tx_data in result
            ] if type(result) == list else [convert_to_transaction(result)]
        except requests.exceptions.HTTPError as e:
    ...
    def close_position(self, owner: Pubkey, position: Position) -> Transaction:
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/close-position",
                                         data=data).json()
    ...
    def get_bin_array_for_swap(self,
                               swap_Y_to_X: bool,
                               count: Optional[int] = 4) -> List[dict]:
        '''
        ...
        try:
            data = json.dumps({"swapYToX": swap_Y_to_X, "count": count})
            result = self.__session.post(
                f"{API_URL}/dlmm/get-bin-array-for-swap", data=data).json()
            return result
        except requests.exceptions.HTTPError as e:
    ...
    def swap_quote(self,
                   amount: int,
                   swap_Y_to_X: bool,
                   allowed_slippage: int,
                   binArrays: List[dict],
                   is_partial_filled: Optional[bool] = False) -> SwapQuote:
        '''
        ...
        if is_partial_filled is not None and isinstance(
                is_partial_filled, bool) == False:
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/swap-quote",
                                         data=data).json()
    ...
    def swap(self, in_token: Pubkey, out_token: Pubkey, in_amount: int,
             min_out_amount: int, lb_pair: Pubkey, user: Pubkey,
             binArrays: List[Pubkey]) -> Transaction:
        '''
        Swap tokens.
        ...
        if type(out_token) != Pubkey:
            raise TypeError(
                "out_token must be of type `solders.pubkey.Pubkey`")
        ...
        try:
            data = json.dumps({
                ...
                str(user),
                "binArrays":
                list(map(lambda x: str(x), binArrays))
            })
            result = self.__session.post(f"{API_URL}/dlmm/swap",
                                         data=data).json()
            return convert_to_transaction(result)
        except requests.exceptions.HTTPError as e:
    ...
    def get_bin_arrays(self) -> List[dict]:
        ...
        try:
            result = self.__session.get(
                f"{API_URL}/dlmm/get-bin-arrays").json()
            return result
        except requests.exceptions.HTTPError as e:
    ...
    def get_dynamic_fee(self) -> float:
        ...
        try:
            result = self.__session.get(
                f"{API_URL}/dlmm/get-dynamic-fee").json()
    ...
    def get_bin_id_from_price(self, price: float, min: bool) -> int | None:
        ...
        try:
            data = json.dumps({"price": price, "min": min})
            result = self.__session.post(
                f"{API_URL}/dlmm/get-bin-id-from-price", data=data).json()
            return int(
                result['binId']) if result.get('binId') is not None else None
        except requests.exceptions.HTTPError as e:
            raise HTTPError(f"Error getting bin id from price: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")

    def get_bins_around_active_bin(self, number_of_bins_to_left: int,
                                   number_of_bins_to_right: int) -> GetBins:
        '''
        ...
        try:
            ...
            result = self.__session.post(
                f"{API_URL}/dlmm/get-bins-around-active-bin",
                data=data).json()
    ...
    def get_bins_between_min_and_max_price(self, min_price: float,
                                           max_price: float) -> GetBins:
        '''
        ...
        try:
            data = json.dumps({"minPrice": min_price, "maxPrice": max_price})
            result = self.__session.post(
                f"{API_URL}/dlmm/get-bins-between-min-and-max-price",
                data=data).json()
            return GetBins(result)
        except requests.exceptions.HTTPError as e:
            raise HTTPError(
                f"Error getting bins between min and max price: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")

    def get_bins_between_lower_and_upper_bound(self, lower_bound: int,
                                               upper_bound: int) -> GetBins:
        '''
        ...
        try:
            ...
            result = self.__session.post(
                f"{API_URL}/dlmm/get-bins-between-lower-and-upper-bound",
                data=data).json()
            return GetBins(result)
        except requests.exceptions.HTTPError as e:
            raise HTTPError(
                f"Error getting bins between lower and upper bound: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")

    def claim_LM_reward(self, owner: Pubkey,
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/claim-lm-reward",
                                         data=data).json()
            return convert_to_transaction(result)
        except requests.exceptions.HTTPError as e:
    ...
    def claim_all_LM_reards(self, owner: Pubkey,
                            positions: List[Position]) -> List[Transaction]:
        '''
        ...
        try:
            ...
            result = self.__session.post(
                f"{API_URL}/dlmm/claim-all-lm-rewards", data=data).json()
    ...
    def claim_swap_fee(self, owner: Pubkey, position: Position) -> Transaction:
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/claim-swap-fee",
                                         data=data).json()
            return convert_to_transaction(result)
        except requests.exceptions.HTTPError as e:
    ...
    def claim_all_swap_fees(self, owner: Pubkey,
                            positions: List[Position]) -> List[Transaction]:
        '''
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/claim-all-swap-fee",
                                         data=data).json()
            return [convert_to_transaction(tx) for tx in result]
        except requests.exceptions.HTTPError as e:
    ...
    def claim_all_rewards(self, owner: Pubkey,
                          positions: List[Position]) -> List[Transaction]:
        '''
        ...
        try:
            ...
            result = self.__session.post(f"{API_URL}/dlmm/claim-all-rewards",
                                         data=data).json()
            return [convert_to_transaction(tx) for tx in result]
        except requests.exceptions.HTTPError as e:
...
class DLMM_CLIENT:
    ...
    @staticmethod
    def get_all_lb_pair_positions_by_user(user: Pubkey,
                                          rpc: str) -> Dict[str, PositionInfo]:
        '''
        ...
        try:
            ...
            data = json.dumps({"user": str(user)})
            result = session.post(
                f"{API_URL}/dlmm/get-all-lb-pair-positions-by-user",
                data=data).json()
            return {key: PositionInfo(value) for key, value in result.items()}
        except requests.exceptions.HTTPError as e:
            raise HTTPError(
                f"Error getting all lb pair positions by user: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")
    ...
    def create_customizable_permissionless_lb_pair(
            ...
            creator_key: Pubkey,
            activation_point: Optional[int] = None) -> Transaction:
        ...
        if (type(creator_key) != Pubkey):
            raise TypeError(
                "creator_key must be of type `solders.pubkey.Pubkey`")
        ...
        try:
            ...
            result = requests.post(
                f"{API_URL}/dlmm/create-customizable-permissionless-lb-pair",
                data=data).json()
            return convert_to_transaction(result)

        except requests.exceptions.HTTPError as e:
            raise HTTPError(
                f"Error creating customizable permissionless lb pair: {e}")
        except requests.exceptions.ConnectionError as e:
            raise HTTPError(f"Error connecting to DLMM: {e}")
